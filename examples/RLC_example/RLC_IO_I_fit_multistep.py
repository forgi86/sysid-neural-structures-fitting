...
#    optimizer = optim.Adam(params, lr=lr)
    ...
    if add_noise:
        model_filename = f"model_IO_I_{seq_len}step_noise.pkl"
    else:
        model_filename = f"model_IO_I_{seq_len}step_nonoise.pkl"
    ...
    if add_noise:
        fig_name = f"RLC_IO_I_loss_{seq_len}step_noise.pdf"
    else:
        fig_name = f"RLC_IO__I_loss_{seq_len}step_nonoise.pdf"
