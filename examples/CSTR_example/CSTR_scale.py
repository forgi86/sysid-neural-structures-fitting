...
if __name__ == '__main__':
    ...
    # In[Plot]
    fig, ax = plt.subplots(3,1,sharex=True)
    ax[0].plot(df_id['Ca'], 'k', label='True')
    ax[0].legend()
    ax[0].grid(True)

    ax[1].plot(df_id['T'], 'k', label='True')
    ax[1].legend()
    ax[1].grid(True)

    ax[2].plot(df_id['q'], 'k', label='True')
    ax[2].legend()
    ax[2].grid(True)
    ...
    # In[Plot]
    fig, ax = plt.subplots(3,1,sharex=True)
    ax[0].plot(df_val['Ca'], 'k',  label='True')
    ax[0].legend()
    ax[0].grid(True)

    ax[1].plot(df_val['T'], 'k', label='True')
    ax[1].legend()
    ax[1].grid(True)

    ax[2].plot(df_val['q'], 'k', label='True')
    ax[2].legend()
    ax[2].grid(True)
